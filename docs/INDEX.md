...
| Documento | Para que sirve |
|---|---|
| `docs/ENTREGAS_HANDOFF.md` | Handoff vivo del **sistema de entregas** (R129-R132): decisiones, arquitectura, API, lo que se probó, 26 trampas conocidas, lo que falta y el estado del material. Retomar el feature desde aquí. |
