# Historial de cambios — Rondas (changelog)

> Bitácora completa de cambios del sistema, ronda por ronda (más reciente primero).
> Este es un documento de consulta puntual: busca una ronda específica, no se lee entero.
>
> **Para entender el sistema** ve `docs/PROYECTO.md` y `docs/ARQUITECTURA.md`.
> **Regla a futuro:** cada cambio nuevo se documenta como una entrada nueva al inicio de la sección de rondas (después de este encabezado).
